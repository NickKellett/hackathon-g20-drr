...
Written by Kathryn Bakos and Dr. Blair Feltmate, this report forms the basis of the Climate Risk Matrices framework we incorporated into the hybrid PRR logical model we are using in this application (as described elsewhere in this content).
...
Intact Centre also publish numerous infographics to quickly summarize effective and inexpensive means Canadians can use to protect their homes and properties from perils including Extreme Heat, Flooding, and Wildfire.

	
## Further Reading

	
- Read about [Intact Centre Climate Risk Matrices](https://www.intactcentreclimateadaptation.ca/integrating-physical-climate-change-risk-into-institutional-investing/)
- Read about [Intact Centre Climate-Ready Infographics](https://www.intactcentreclimateadaptation.ca/climate-ready-infographics/)
- Read about [OS-Climate](/about/os\_climate)
- Read about [Deploy Software Solutions](/about/deploy\_software\_solutions)