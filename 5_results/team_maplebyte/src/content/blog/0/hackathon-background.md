...
- Change Detection – Identify recent growth in informal settlements.
- Forecast Expansion – Predict development over 1–3 years.
- Risk Classification – Overlay forecasts with flood hazard maps.
...
- *"Improved ability to forecast and visualise informal urban expansion and associated flood risks using open geospatial and machine learning tools.*
- *"Strengthened national and international capacity in the application of AI, data science, and ethical innovation for disaster risk reduction (DRR).*
- *"Enhanced collaboration across government, academia, civil society, and the private sector in support of resilient, data-informed urban development.*
- *"Increased awareness and use of open innovation mechanisms to address climate vulnerability, urbanisation challenges, and inclusive service delivery.*
- *"Policy-relevant insights and technical models that can support municipal early warning systems, upgrade planning, and spatial targeting of infrastructure investment."*
